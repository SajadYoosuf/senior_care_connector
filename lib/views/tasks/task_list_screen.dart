...
import 'package:senior_care/widgets/task_card.dart';
import 'package:senior_care/views/tasks/task_details_screen.dart';
import 'package:senior_care/views/tasks/add_task_screen.dart';
            ...
            child: ValueListenableBuilder(
              ...
              builder: (context, box, _) {
                final userTasksRaw = box.keys
                    ...
                    .where(
                      (e) =>
                          e['userId'] == context.read<AuthViewModel>().user?.id,
                    )
                    .toList();
