...
class AdminDashboardScreen extends StatelessWidget {
        ...
        title: Row(
          children: [
            CircleAvatar(
              ...
              backgroundImage: authViewModel.user?.profileImageUrl != null
                  ? NetworkImage(authViewModel.user!.profileImageUrl!)
                  : null,
              child: authViewModel.user?.profileImageUrl == null
                  ? Text(
                      (authViewModel.user?.name ?? 'A')[0].toUpperCase(),
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                onPressed: () => _showBroadcastDialog(context, adminViewModel),
            ...
            GridView.count(
              ...
              children: [
                _buildStatCard(
                  title: 'Total Seniors',
                  count: adminViewModel.seniorCount.toString(),
                  icon: Icons.accessible_forward,
                  color: Colors.blue,
                ),
                _buildStatCard(
                  title: 'Volunteers',
                  count: adminViewModel.volunteerCount.toString(),
                  icon: Icons.volunteer_activism,
                  color: Colors.green,
                ),
                _buildStatCard(
                  title: 'Pending',
                  count: adminViewModel.pendingTaskCount.toString(),
                  icon: Icons.pending_actions,
                  color: Colors.orange,
                ),
                _buildStatCard(
                  title: 'Today\'s Visits',
                  count: adminViewModel.todayActiveUsersCount.toString(),
            ...
            _buildAnalyticsChart(adminViewModel),
            ...
            const SizedBox(height: 12),
            _buildActivityLog(adminViewModel),
          ],
        ),
      ),
    );
  ...
  Widget _buildActivityLog(AdminViewModel provider) {
  ...
  Widget _buildAnalyticsChart(AdminViewModel provider) {
  ...
  void _showBroadcastDialog(BuildContext context, AdminViewModel provider) {
