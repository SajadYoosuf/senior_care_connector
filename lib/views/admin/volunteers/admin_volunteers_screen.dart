...
import 'package:senior_care/views/admin/volunteers/admin_volunteer_details_screen.dart';
...
class _AdminVolunteersScreenState extends State<AdminVolunteersScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final filteredVolunteers = volunteers.where((v) {
      ...
      if (selectedFilter == 'Active')
        return v['isApproved'] == true && v['isActive'] != false;
        ...
        children: [
          ...
          Expanded(
            child: filteredVolunteers.isEmpty
                ? const Center(
                    child: Text('No volunteers found matching filters'),
                  )
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _buildVolunteerCard(volunteer, adminViewModel);
                    },
                  ),
          ),
        ],
  ...
  Widget _buildVolunteerCard(Map<String, dynamic> v, AdminViewModel provider) {
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      v['profession']?.toString().isNotEmpty == true
                          ? v['profession']
                          : 'No profession',
                      style: TextStyle(
            ...
            children: [
              ...
              OutlinedButton(
                onPressed: () => Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        AdminVolunteerDetailsScreen(volunteer: v),
                  ),
                ),
