...
import 'package:senior_care/views/volunteer/contact/volunteer_contact_screen.dart';
...
import 'package:senior_care/repositories/activity_log_repository.dart';
                  ...
                  return ElevatedButton(
                    ...
                    onPressed: taskViewModel.isLoading
                        ...
                        : () async {
                            ...
                            try {
                              if (isAccepted) {
                                await taskViewModel.completeTask(widget.task.id);
                                ...
                                await taskViewModel.acceptTask(
                                  widget.task.id,
                                  auth.user!.id,
                                );
