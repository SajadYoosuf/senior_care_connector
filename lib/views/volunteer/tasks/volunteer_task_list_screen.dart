...
import 'package:senior_care/views/volunteer/tasks/volunteer_task_details_screen.dart';
...
class _VolunteerTaskListScreenState extends State<VolunteerTaskListScreen> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () async {
                  final success = await authViewModel.updateLocation();
  ...
  // Task mapping removed - now handled by TaskViewModel and Repository
