...
import 'package:senior_care/views/volunteer/tasks/volunteer_my_tasks_screen.dart';
import 'package:senior_care/views/notifications/notification_screen.dart';
import 'package:senior_care/views/volunteer/chat/volunteer_support_chat_screen.dart';
        ...
        title: Row(
          children: [
            CircleAvatar(
              ...
              child: Text(
                context.watch<AuthViewModel>().user?.name.isNotEmpty == true
                    ? context.watch<AuthViewModel>().user!.name[0].toUpperCase()
                    : 'V',
            ...
            children: [
              ...
              Builder(
                builder: (context) {
                  ...
                  final userLat = authViewModel.user?.latitude;
                  final userLng = authViewModel.user?.longitude;
                  ...
                  if (userLat != null && userLng != null) {
                    return StreamBuilder<List<TaskEntity>>(
                      stream: context.read<TaskViewModel>().watchNearbyTasks(
                        ...
                        userLng,
                        5.0,
                        excludeUserId: authViewModel.user?.id,
                      ),
                      ...
                      if (!isDenied) {
                        WidgetsBinding.instance.addPostFrameCallback((_) async {
                          ...
                          if (serviceEnabled && context.mounted) {
                            context.read<AuthViewModel>().updateLocation();
                          }
                        });
