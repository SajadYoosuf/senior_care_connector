...
import 'package:senior_care/widgets/role_card.dart';
import 'package:senior_care/views/sign_up_screen.dart';
  ...
  void _continue() async {
    if (selectedRole != null) {
      if (widget.isPostAuth) {
        ...
        final success = await authViewModel.updateUserRole(selectedRole!);
        if (success) {
          if (!mounted) return;
