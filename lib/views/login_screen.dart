...
import 'package:senior_care/views/forgot_password_screen.dart';
...
class LoginScreen extends StatelessWidget {
  ...
  void _handleLogin(BuildContext context, AuthViewModel authViewModel) async {
    final success = await authViewModel.login(role);
    if (success) {
            ...
            child: Column(
              ...
              children: [
                ...
                CustomTextField(
                  ...
                  isPassword: true,
                  obscureText: !authViewModel.isLoginPasswordVisible,
                  onPasswordToggle: authViewModel.toggleLoginPasswordVisibility,
                  prefixIcon: const Icon(
                    Icons.lock_outline,
                    color: AppColors.grey,
                  ),
