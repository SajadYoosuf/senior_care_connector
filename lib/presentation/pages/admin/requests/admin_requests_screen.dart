...
class _AdminRequestsScreenState extends State<AdminRequestsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final requests = adminProvider.helpRequests;
            ...
            child: filteredRequests.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _buildRequestCard(req, adminProvider);
                    },
                  ),
          ),
        ],
  ...
  Widget _buildRequestCard(Map<String, dynamic> req, AdminProvider adminProvider) {
            ...
            if (status == 'Pending')
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  onPressed: () => _showAssignSheet(context, req['id'], adminProvider),
  ...
  void _showAssignSheet(BuildContext context, String requestId, AdminProvider adminProvider) {
    showModalBottomSheet(
      ...
      builder: (context) {
        final volunteers = adminProvider.volunteers.where((v) => v['isApproved'] == true && v['isActive'] != false).toList();
