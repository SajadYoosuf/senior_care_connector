    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          print('AdminChatListScreen: Total messages found: ${allMessages.length}');
          ...
          // Group messages by their parent chat (User ID)
          final Map<String, QueryDocumentSnapshot> latestMessagesPerChat = {};
          
          for (var doc in allMessages) {
            // Get the userId from the path: support_chats/{userId}/messages/{messageId}
            final userId = doc.reference.parent.parent?.id;
            if (userId != null && !latestMessagesPerChat.containsKey(userId)) {
              latestMessagesPerChat[userId] = doc;
            }
          }

          final chatIds = latestMessagesPerChat.keys.toList();
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              final volunteerId = chatIds[index];
              final lastMessageDoc = latestMessagesPerChat[volunteerId]!;
